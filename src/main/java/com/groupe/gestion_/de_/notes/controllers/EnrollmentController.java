...
public class EnrollmentController {
    ...
    @PreAuthorize("hasRole('ADMIN') or " +
            "(hasRole('TEACHER') and @objectLevelSecurity.isTeacherAssignedToEnrollment(#id)) or " +
            "(hasRole('STUDENT') and @objectLevelSecurity.isStudentOwnerOfEnrollment(#id))")
    ...
    @PreAuthorize("hasRole('ADMIN') or " +
            "(hasRole('TEACHER') and @objectLevelSecurity.isTeacherAssignedToStudent(#studentId)) or " +
            "(hasRole('STUDENT') and @objectLevelSecurity.isStudentOwner(#studentId))")
